  ...
  return (
    <>
      ...
      <aside style={{marginTop:"65px"}}
        className={`fixed left-0 top-0 h-screen bg-white shadow-lg flex flex-col transition-all duration-300 ease-in-out pb-5 ${isMobile && collapsed ? "w-0 " : collapsed ? "w-20" : "w-56"}`}
