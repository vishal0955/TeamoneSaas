          ...
          <ul>
            ...
            {addedTags.map((tag) => (
              <li key={tag.id} className="mb-1 flex items-center justify-between bg-gray-200 p-2 rounded" style={{margin:"10px"}}>
                ...
                <FaTrash className="text-red-500 cursor-pointer" onClick={() => handleRemoveTag(tag.id)} />
              </li>
            ))}
          </ul>
                    ...
                    <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mt-2 gap-2">
                      ...
                      <div className="flex items-center gap-3">
                        ...
                        <div className="flex">
                          ...
                          >
                            <Star size={16} className={note.starred ? "text-yellow-500 fill-yellow-500" : ""} />
                          </button>
                          <button
                    ...
                    <div className="flex items-center mt-4">
                      ...
                      <div className="flex">
                        <button
                          ...
                          onClick={() => handleToggleStar(note.id)}
                        >
                          <FaStar className={`w-4 h-4 ${note.starred ? "text-yellow-500" : ""}`} />
                        </button>
                        <button
                          className="p-1 text-gray-400 hover:text-red-500"
                          onClick={() => handleDeleteNote(note.id)}
