      ...
      <div className="p-6 bg-gray-100 min-h-screen">
        <div className="flex justify-between items-center mb-4">
          ...
          <div className="flex space-x-3">
            ...
            <Button className="border px-4 py-2 rounded-md">2025</Button>
          </div>
        </div>
        <Card className="shadow-md bg-white p-6 rounded-lg flex items-center justify-between">
          <div className="flex items-center">
            <img
            ...
            />
            <div>
              <h3 className="text-lg font-semibold">Welcome Back, Adrian</h3>
