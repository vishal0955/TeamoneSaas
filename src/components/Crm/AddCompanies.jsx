  ...
  <div className="form-container bg-white shadow-sm rounded-3 p-4">
    ...
    <div className="tab-content">
      ...
      <div className="tab-pane fade show active" id="basic" role="tabpanel">
        <label htmlFor="companyLogo" className="upload-image" id="uploadArea">
        ...
        <div className="row g-3">
          ...
          <div className="col-md-6">
            <label className="form-label required">Phone Number 1</label>
        ...
        <div className="d-flex justify-content-between align-items-center mt-4 pt-3 border-top">
          <div>
            ...
            <div className="d-flex align-items-center">
              <img
                src="https://i.ibb.co/kVGZvBvs/user-11.jpg"
