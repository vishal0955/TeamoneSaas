...
//                                   onChange={(e) => setNewTaskText({...newTaskText, [columnId]: e.target.value})}
//                                   autoFocus
//                                 />
//                                 <div className="flex justify-end space-x-2">
//                                   <button
//                                     onClick={() => cancelAddTask(columnId)}
...
const KanbanBoard = () => {
  ...
  // Get an array of column IDs and data for rendering
  const columnOrder = Object.keys(columns);
  const columnsArray = columnOrder.map(columnId => columns[columnId]);
