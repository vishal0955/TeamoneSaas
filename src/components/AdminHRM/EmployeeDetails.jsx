...
// const EmployeeDetails = () => {
//   const { id } = useParams();
//   const numericId = Number(id.replace("EMP", ""));
...
//                     {employee.name}
//                   </h1>
//                   <p className="text-gray-600 text-lg mb-2">{employee.role}</p>
//                 </div>
//                 <button className="px-4 py-2.5 text-white bg-gray-800 border border-black rounded-lg">
//                   <FaPenToSquare className="mr-2 inline" />
//                   Edit Profile
//                 </button>
//               </div>
...
//               </div>
//             )}
//             {activeTab === "work" && <p>Work details content here...</p>}
//             {activeTab === "documents" && <p>Documents content here...</p>}
//             {activeTab === "attendance" && <p>Attendance & Leave details...</p>}
//           </div>
//         </div>
