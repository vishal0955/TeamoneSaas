    ...
    <div className="bg-white">
      ...
      >
        <div className="flex items-center">
          <svg 
            className={`w-4 h-4 mr-2 transform transition-transform ${isExpanded ? 'rotate-0' : '-rotate-90'}`}
            fill="none" 
            stroke="currentColor" 
            viewBox="0 0 24 24"
          >
      ...
      {isExpanded && (
        <div className="p-3 border-t">
          <div className="space-y-4">
            ...
            <div>
              <label className="block text-xs text-gray-500 mb-1">Buying Role</label>
              <input
                type="text"
            ...
            <div>
              <label className="block text-xs text-gray-500 mb-1">Contact owner</label>
              <input
                type="text"
