...
const activities = [
  { activity: "User logged in", time: "2025-04-23 10:30 AM" },
  { activity: 'Task "Homepage Design" submitted', time: "2025-04-23 09:50 AM" },
  { activity: "Feedback added on Project Alpha", time: "2025-04-22 05:15 PM" },
  { activity: "Leave request submitted", time: "2025-04-22 04:00 PM" },
  { activity: 'Task "Logo Concept" updated', time: "2025-04-22 01:45 PM" },
  { activity: "Meeting scheduled with Client X", time: "2025-04-21 03:30 PM" },
  { activity: "User logged out", time: "2025-04-21 02:00 PM" },
  { activity: 'Task reassigned: "UI Review"', time: "2025-04-21 11:25 AM" },
  {
    activity: 'Document uploaded: "Design Brief.pdf"',
    time: "2025-04-20 04:45 PM",
  },
  {
    activity: 'Comment added to Task "Wireframe Review"',
    time: "2025-04-20 03:10 PM",
  },
];
const PerformanceOverview = () => {
  ...
  const [selectStaff, setSelectedStaff] = useState();
  const staffList = [
    { name: "jonh" },
    { name: "jonh smith" },
    { name: "joy" },
                    ...
                    <div className=" rounded-lg p-4">
                      {[
                        ...
                        >
                          <div className="flex items-center">
                            <i
                              className={`fas ${kpi.icon} ${kpi.color} mr-2`}
                            ></i>
