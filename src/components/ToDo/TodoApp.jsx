...
const TodoApp = () => {
  ...
  const filteredTasks = tasks
    .filter((task) => {
      if (activeFilter !== "all" && task.priority !== activeFilter)
        return false;
  ...
  const handleAddTask = (newTaskData, updatedEmployees) => {
    ...
    if (editingTask) {
      ...
      const newTaskObj = {
        ...
        assignees: Array.isArray(newTaskData.assignees)
  ...
  return (
    <div className={` ${darkMode ? "" : null} min-h-screen `}>
      <div className=" mx-auto px-3 px-md-4 px-lg-5 py-4">
        ...
        <div className="d-flex flex-column flex-md-row align-items-center justify-content-between mb-4">
          <div className="mb-2 mb-md-0">
            <h2 className="h5 mb-0">
              Total Todo <small className="text-muted">{tasks.length}</small>
            </h2>
          </div>
          ...
          <div className="d-flex flex-wrap justify-content-center justify-content-md-end gap-2 gap-md-3">
            ...
            <span>
              <button
                ...
                readOnly
                style={{background:"#2e32b9", color:"white"}}
              >
                New Task
              </button>
            </span>
            ...
            <div className="btn-group " role="group">
              <button
                className={`btn btn-sm ${
                  activeFilter === "all" ? "btn-dark" : "btn-light"
                }`}
              ...
              <button
                className={`btn btn-sm ${
                  activeFilter === "high" ? "btn-dark" : "btn-light"
                }`}
              ...
              <button
                className={`btn btn-sm ${
                  activeFilter === "medium" ? "btn-dark" : "btn-light"
                }`}
              ...
              <button
                className={`btn btn-sm ${
                  activeFilter === "low" ? "btn-dark" : "btn-light"
                }`}
          ...
          <div className="col-12 col-md-6">
            <div className="row g-2">
              <div className="col-4 col-sm-4">
                <label
                  className={`${darkMode ? "dark-mode" : ""} form-label small`}
                >
                  Due Date
                </label>
                <input
                            ...
                            {task.tags.map((tag) => (
                              <span
                                ...
                                className={`${getTagColor(
                                  tag
                                )} small px-2 py-1 rounded me-1 mb-1`}
                              >
                                {tag}
                              </span>
                            ))}
        ...
        {(activeFilter === "all" || activeFilter === "low") &&
