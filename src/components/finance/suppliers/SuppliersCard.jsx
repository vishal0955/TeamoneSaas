        ...
        <div className="max-w-8xl mx-auto px-4">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 h-auto py-4 sm:h-16">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center sm:space-x-4">
              ...
              <h1 className="text-lg font-semibold mt-2 sm:mt-0 sm:w-auto w-full">
                supplier-name.com
              </h1>
            </div>
            ...
            <div className="flex flex-col sm:flex-row sm:items-center sm:space-x-4 gap-2 w-full sm:w-auto">
              <button className="w-full sm:w-auto !rounded-button px-4 py-2 text-gray-700 bg-white border border-gray-300 hover:bg-gray-100">
            ...
            <div className="bg-white rounded-lg shadow mb-6">
              <div className="border-b border-gray-200">
                <div className="flex flex-wrap gap-2 sm:space-x-4 sm:flex-nowrap p-4">
                  <button className="!rounded-button px-4 py-2 hover:bg-gray-100 flex items-center">
                ...
                <div className="space-y-6">
                  ...
                  <section>
                    ...
                    <div className=" row space-x-4">
                      ...
                      <button className="!rounded-button flex items-center px-4 py-2 border border-gray-300 hover:bg-gray-50 mt-2 " style={{marginLeft:"0px"}}>
                  ...
                  <section>
                    ...
                    <div className="row  space-x-4 mb-4">
                      ...
                      <select className="!rounded-button border border-gray-300 px-4 py-2 mt-2 " style={{marginLeft:"0px"}}>
