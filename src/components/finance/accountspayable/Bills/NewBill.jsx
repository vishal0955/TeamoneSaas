      ...
      <form className="p-6">
        ...
        <div className="flex justify-between items-start mb-6">
          <div className="space-x-4">
            ...
            <button className="!rounded-button inline-flex items-center px-4 py-2 border border-gray-300 text-sm font-medium rounded-md bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-custom">
        ...
        <div className="flex justify-between items-center pt-6 border-t">
          ...
          <div className="space-x-4">
            ...
            <button className="!rounded-button inline-flex items-center px-4 py-2 border border-gray-300 text-sm font-medium rounded-md bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500">
              Cancel
            </button>
          </div>
        </div>
