      ...
      <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between space-y-4 lg:space-y-0 mb-6">
        ...
        <div className="flex flex-wrap items-center gap-4">
          <div className="relative">
            <input
              type="date"
              className="pl-4 pr-10 py-2 border border-gray-300 rounded-md focus:ring-custom focus:border-custom"
            />
          </div>
          <div className="relative">
            <input
          ...
          <select className="pl-4 pr-10 py-2 border border-gray-300 rounded-md focus:ring-custom focus:border-custom appearance-none">
            <option>Any date</option>
            <option>Last 7 days</option>
            <option>Last 30 days</option>
            <option>Last 90 days</option>
          </select>
          <button className="inline-flex items-center px-4 py-2 border border-gray-300 rounded-md text-sm font-medium text-gray-700 bg-white hover:bg-gray-50 !rounded-button">
