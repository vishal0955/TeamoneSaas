...
const PurchaseOrder = () => {
  return (
    <div className="max-w-8xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <h1 className="text-2xl font-semibold text-gray-900">      Purchase Orders
      </h1>
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
      <div className="bg-white rounded-lg p-6 shadow-sm">
        <div className="mb-2">
          ...
          <p className="text-2xl font-semibold text-gray-900">$3,237.94</p>
        </div>
    ...
    <div className="bg-white rounded-lg shadow-sm">
      <div className="p-6 border-b border-gray-200">
        <div className="flex flex-col sm:flex-row gap-4">
          ...
          <div className="flex gap-4">
            <select className="border border-gray-300 rounded-md py-2 pl-3 pr-8 focus:ring-custom focus:border-custom">
              <option>All</option>
            </select>
            <select className="border border-gray-300 rounded-md py-2 pl-3 pr-8 focus:ring-custom focus:border-custom">
      ...
      <div className="px-6 py-4 flex items-center justify-between border-t border-gray-200">
        <div className="flex-1 flex justify-between sm:hidden">
          <button className="!rounded-button bg-white border border-gray-300 text-gray-700 px-4 py-2 text-sm font-medium hover:bg-gray-50">
            Previous
          </button>
          <button className="!rounded-button ml-3 bg-white border border-gray-300 text-gray-700 px-4 py-2 text-sm font-medium hover:bg-gray-50">
            Next
          </button>
        </div>
        <div className="hidden sm:flex-1 sm:flex sm:items-center sm:justify-between">
          <div>
            ...
            >
              ...
              <button className="!rounded-button bg-white border-gray-300 text-gray-700 hover:bg-gray-50 relative inline-flex items-center px-4 py-2 border text-sm font-medium">
                2
              </button>
