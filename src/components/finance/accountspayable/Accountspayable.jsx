      ...
      <div className="mt-4 flex items-center justify-between">
        <div className="flex items-center gap-4">
              ...
              <div className="relative dropdown">
                <button
                  className="!rounded-button bg-white border border-gray-300 px-4 py-2 text-sm font-medium text-gray-700 hover:bg-gray-50 flex items-center gap-2"
                  ...
                  <div className="absolute top-full left-0 mt-1 w-48 bg-white rounded-lg shadow-lg border border-gray-200 z-10">
                    <ul className="py-2">
                      <li >
                          ...
                          <Link to='/finance/allbills'   className="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 flex items-center gap-2">
                      ...
                      <li>
                                ...
                                <li>
                                    <Link to="/finance/expense" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 flex items-center gap-2">
                                        <i class="fas fa-wallet text-gray-400"></i> Expense
                                    </Link>
                                </li>
                                <li>
                                    <Link to="/finance/Purchaseorder" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 flex items-center gap-2">
                                        <i class="fas fa-shopping-cart text-gray-400"></i> Purchase Order
                                    </Link>
                                </li>
                                {/* <li>
...
function BillsChart() {
  useEffect(() => {
    ...
    billsChart.setOption({
      ...
      xAxis: {
        type: 'category',
        data: ['Older', '15-21 Dec', 'This week', '29 Dec-4 Jan', '5-11 Jan', 'Future'],
        axisLabel: {
          fontSize: 10,
        },
      },
