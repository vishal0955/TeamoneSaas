    ...
    <div className="bg-gray-50 min-h-screen px-4 sm:px-6 lg:px-8 py-8">
      <div className="max-w-8xl mx-auto">
        ...
        <div className="flex justify-between items-center mb-6">
          <div className="flex items-center gap-4">
            ...
            <div className="flex gap-2">
              ...
              <button className="!rounded-button bg-white border border-gray-300 px-4 py-2 text-sm font-medium">
                Send Statements
              </button>
              <button className="!rounded-button bg-white border border-gray-300 px-4 py-2 text-sm font-medium">
                Import
          ...
          <div className="relative">
            <input type="text" placeholder="Search" className="!rounded-button pl-10 pr-4 py-2 border border-gray-300 w-64" />
        ...
        <div className="grid grid-cols-4 gap-4 mb-8">
          {[
            { label: "Total Invoice", amount: "$3,237.94", change: "+32.40%", color: "bg-custom" },
            { label: "Outstanding", amount: "$3,237.94", change: "-4.40%", color: "bg-red-500" },
            { label: "Draft", amount: "$3,237.94", change: "-12%", color: "bg-yellow-500" },
            { label: "Total Overdue", amount: "$3,237.94", change: "-15.40%", color: "bg-red-500" },
          ].map((card, idx) => (
            <div key={idx} className="bg-white rounded-lg p-4 shadow-sm">
              ...
              <div className="flex items-baseline">
                ...
                <span className={`ml-2 text-sm font-medium ${card.color === "bg-custom" ? "text-green-500" : "text-red-500"}`}>
                  {card.change}
                </span>
              </div>
        ...
        <div className="mb-6 border-b border-gray-200">
          <nav className="-mb-px flex space-x-8">
            {["Invoices", "Paid", "Repeating", "See all"].map((tab, idx) => (
              <a key={idx} href="#" className={`py-4 px-1 text-sm font-medium ${idx === 0 ? "text-custom border-b-2 border-custom" : "text-gray-500 hover:text-gray-700"}`}>
                {tab}
              </a>
            ))}
          </nav>
        ...
        <div className="grid grid-cols-2 gap-8 mb-8">
          <div className="bg-white rounded-lg p-6 shadow-sm">
            <h3 className="text-lg font-medium text-gray-900 mb-4">Money Coming In</h3>
            <div id="barChart" style={{ width: "100%", height: "300px" }}></div>
          </div>
          <div className="bg-white rounded-lg p-6 shadow-sm">
            <div className="flex justify-between items-center mb-4">
              <h3 className="text-lg font-medium text-gray-900">Customers Owing the Most</h3>
              <div className="flex gap-2">
            ...
            <div className="space-y-3">
              {["Client X", "Client Y", "Client Z", "Client A", "Client B"].map((client, idx) => (
