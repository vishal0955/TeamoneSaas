...
const Users = () => {
  ...
  const initialUsers = [
    ...
    { id: 4, name: "Jessica Smith", email: "jessica@example.com", createdDate: "20 Sep 2024", role: "Client", status: "Active" },
    { id: 5, name: "David Lee", email: "david@example.com", createdDate: "22 Sep 2024", role: "Employee", status: "Inactive" },
    { id: 6, name: "Laura Black", email: "laura@example.com", createdDate: "25 Sep 2024", role: "Employee", status: "Active" },
    { id: 7, name: "John Brown", email: "john@example.com", createdDate: "28 Sep 2024", role: "Client", status: "Inactive" },
    { id: 8, name: "Emily Davis", email: "emily@example.com", createdDate: "30 Sep 2024", role: "Employee", status: "Active" },
    { id: 9, name: "Charles Miller", email: "charles@example.com", createdDate: "02 Oct 2024", role: "Client", status: "Inactive" },
    { id: 10, name: "Olivia Wilson", email: "olivia@example.com", createdDate: "05 Oct 2024", role: "Employee", status: "Active" },
    { id: 11, name: "James Martinez", email: "james@example.com", createdDate: "07 Oct 2024", role: "Client", status: "Active" },
    { id: 12, name: "Sophia Taylor", email: "sophia@example.com", createdDate: "10 Oct 2024", role: "Employee", status: "Inactive" },
    { id: 13, name: "Daniel Anderson", email: "daniel@example.com", createdDate: "12 Oct 2024", role: "Client", status: "Active" },
    { id: 14, name: "Mia Thomas", email: "mia@example.com", createdDate: "15 Oct 2024", role: "Employee", status: "Inactive" },
    { id: 15, name: "Ethan Jackson", email: "ethan@example.com", createdDate: "18 Oct 2024", role: "Client", status: "Active" },
    { id: 16, name: "Ava Harris", email: "ava@example.com", createdDate: "20 Oct 2024", role: "Employee", status: "Inactive" },
    { id: 17, name: "Isabella Martin", email: "isabella@example.com", createdDate: "22 Oct 2024", role: "Client", status: "Active" },
    { id: 18, name: "Lucas Thompson", email: "lucas@example.com", createdDate: "25 Oct 2024", role: "Employee", status: "Inactive" },
    { id: 19, name: "Zoe Moore", email: "zoe@example.com", createdDate: "27 Oct 2024", role: "Client", status: "Active" },
    { id: 20, name: "Liam Scott", email: "liam@example.com", createdDate: "30 Oct 2024", role: "Employee", status: "Active" },
  ];
